...
export default function Home() {
  ...
  // Charger les signalements depuis Firestore au démarrage
  useEffect(() => {
    fetchSignalements();
  }, []);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // Téléversement de la photo sur Firebase Storage si présent
      if (form.photo) {
      ...
      // Sauvegarde du signalement dans Firestore
      ...
      alert("Signalement enregistré avec succès dans Firebase !");
